...
with open('webecom\chatbot\static\data.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
with open('webecom/chatbot/static/texts.pkl', 'wb') as file:
    pickle.dump(ds_tu, file)
with open('webecom/chatbot/static/labels.pkl', 'wb') as file:
...
model.save('webecom/chatbot/static/model.keras')
